...
class customMenu extends WP_Widget {
	public function __construct() {
        $idwidget = 'custommenu';
        $namewidget = '✔️ Custom Menu';
        $descwidget = 'Widget ini menampilkan data menu secara custom yang dapat diatur berdasarkan menu yang diinginkan';
		$widget_ops = array(
	...
	public function widget( $args, $instance ) {
		if($instance['mobile'] == 'yes'){
			if (function_exists( 'is_amp_endpoint' ) && is_amp_endpoint()) {
        		...
        		echo str_replace("widget", "widget custommenu", $args['before_widget']);
        		if ( $title ) {
...
function customMenuload() {
    register_widget( 'customMenu' );
}
add_action( 'widgets_init', 'customMenuload' );